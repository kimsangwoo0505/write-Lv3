...
//        }
    ...
    public WriteWithLettersResponseDto getLetterInWrite(Long writeId, HttpServletRequest request) {
...
//
    ...
    public ResponseDto deleteWrite(Long id, HttpServletRequest request) {
            ...
            if (token != null) {
                ...
                // Write 행을 삭제하기 전에 관련된 Letter 행을 먼저 삭제
//                letterRepository.deleteByWriteId(write.getId());
